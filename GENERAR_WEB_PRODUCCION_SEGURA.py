...
bundles=[pack(['configuracion.js','conexion.js','acceso.js'],'sgf-login.4320.js','LOGIN'),pack(['configuracion.js','conexion.js','menu-principal.js'],'sgf-shell.4320.js','SHELL'),pack(['configuracion.js','mapa.js','conexion.js','jszip.min.js','qr-flotas.js','reportes-exportacion.js','sgf-publicador-android.js','aplicacion.js'],'sgf-module.4320.js','MODULO')]
p=out/'index.html';t=p.read_text();t=re.sub(r'<script src="configuracion\.js[^>]*></script>\s*<script src="conexion\.js[^>]*></script>\s*<script src="acceso\.js[^>]*></script>','<script src="sgf-login.4320.js?v=web4320-cache-final"></script>',t);p.write_text(t)
p=out/'main.html';t=p.read_text();t=re.sub(r'<script src="configuracion\.js[^>]*></script>\s*<script src="conexion\.js[^>]*></script>\s*<script src="menu-principal\.js[^>]*></script>','<script src="sgf-shell.4320.js?v=web4320-cache-final"></script>',t);p.write_text(t)
