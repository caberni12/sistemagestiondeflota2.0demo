(function () {
  ...
  async function renderOficinaVirtual(){
    ...
    const suggestions=currentUser?.ROL_ID==='ROL-CONDUCTOR'?['¿Tengo vehículo asignado?','Muéstrame mi licencia de conducir','Documentos de mi vehículo asignado','¿Qué alertas tengo?','¿Qué tengo pendiente?']:['¿Tengo vehículo asignado?','Muéstrame mi licencia de conducir','Documentos de mi vehículo asignado','¿Qué alertas tengo?','¿Hay excesos de velocidad?'];
