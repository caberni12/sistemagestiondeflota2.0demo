(function () {
  ...
  async function renderActualizacionesApp(){
    ...
    return heading('CENTRO DE DISTRIBUCIÓN ANDROID','Actualización de Aplicación','Importe una APK: SGF detecta versión, versionCode y SHA-256, la carga a Drive y notifica solo después de confirmar la publicación.',latest?`<button class="btn soft" type="button" data-resend-update="${esc(latest.ID)}">↻ Reenviar alertas pendientes</button>`:'')+
