...
required = [
    ...
    'CAMBIOS_VERSION_3.18.2.md', 'LEEME_ACTUALIZACION_3.18.2.md', 'PRUEBAS_VERSION_3.18.2.md',
]
...
for value in [
    "VERSION: '3.18.2'", 'data-open-fuel-qr', 'data-open-checkin-qr',
...
for value in [
    "const VERSION_APLICACION = '3.18.2'", 'normalizarContextoQrVehiculo_',
...
for html in root.glob('*.html'):
    ...
    if 'aplicacion.js' in text and 'aplicacion.js?v=3.18.2' not in text:
        errors.append(f'{html.name} no referencia aplicacion.js 3.18.2')
...
print('Sistema web 3.18.2 verificado correctamente.')
