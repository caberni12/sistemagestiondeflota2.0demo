(function(){
  ...
  async function actualizarAvisos(){
    ...
    consultaAvisosPendiente=(async()=>{
      ...
      if(puedeAvisos('NOTIFICACIONES'))consultas.push({key:'assignments',action:'assignmentAlerts',payload:{limit:20,cache:false}});
